...
async start(){
 if(typeof DeviceMotionEvent!=="undefined"&&typeof DeviceMotionEvent.requestPermission==="function"){
   if(await DeviceMotionEvent.requestPermission()!=="granted")throw Error("Motion permission denied")
 }
 ...
 addEventListener("devicemotion",e=>{
   ...
   this.onMotion&&this.onMotion(this);
 },{passive:true});
 addEventListener("deviceorientation",e=>{
   ...
   this.onOrientation&&this.onOrientation(this);
 },{passive:true});
}}